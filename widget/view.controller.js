...
(function () {
  ...
  cyberThreatWorldMap100Ctrl.$inject = ['$scope', 'PagedCollection', 'config', 'ALL_RECORDS_SIZE', 'widgetUtilityService'];

  function cyberThreatWorldMap100Ctrl($scope, PagedCollection, config, ALL_RECORDS_SIZE, widgetUtilityService) {
    ...
    $scope.$on('$destroy', function () {
      document.getElementById(`world-map-${config.wid}`).remove();
    });
